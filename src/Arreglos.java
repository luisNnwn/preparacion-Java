    ...
    public static void main(String[] args) {
      ...
      /*PASO VALOR Y REFERENCIA*/
        ...
        * de las cosas directamente.*/
        ...
        busquedaBinariaArreglos busqueda2 = new busquedaBinariaArreglos();
        int valorABuscar = 7;
        int elementoEncontrado2 = busqueda2.busquedaBinaria(valorABuscar, arreglo3);
        if (elementoEncontrado2 != 1) {
            System.out.println("Elemento encontrado = " + elementoEncontrado2);
        } else {
            System.out.println("Elemento no encontrado");
        }
